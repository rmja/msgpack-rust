...
/// successful read.
pub fn read_fixext1<R: Read<E>, E: ReadError>(rd: &mut R) -> Result<(i8, u8), ValueReadError<E>> {
...
/// This function will return `ValueReadError` on any I/O error while reading either the marker or
/// the data.
pub fn read_fixext2<R: Read<E>, E: ReadError>(rd: &mut R) -> Result<(i8, [u8; 2]), ValueReadError<E>> {
    match read_marker(rd)? {
        Marker::FixExt2 => {
            let mut buf = [0; 2];
...
/// This function will return `ValueReadError` on any I/O error while reading either the marker or
/// the data.
pub fn read_fixext4<R: Read<E>, E: ReadError>(rd: &mut R) -> Result<(i8, [u8; 4]), ValueReadError<E>> {
    match read_marker(rd)? {
        Marker::FixExt4 => {
            let mut buf = [0; 4];
            read_fixext_data(rd, &mut buf).map(|ty| (ty, buf))
...
/// This function will return `ValueReadError` on any I/O error while reading either the marker or
/// the data.
pub fn read_fixext8<R: Read<E>, E: ReadError>(rd: &mut R) -> Result<(i8, [u8; 8]), ValueReadError<E>> {
    match read_marker(rd)? {
        Marker::FixExt8 => {
            let mut buf = [0; 8];
            read_fixext_data(rd, &mut buf).map(|ty| (ty, buf))
...
/// This function will return `ValueReadError` on any I/O error while reading either the marker or
/// the data.
pub fn read_fixext16<R: Read<E>, E: ReadError>(rd: &mut R) -> Result<(i8, [u8; 16]), ValueReadError<E>> {
    match read_marker(rd)? {
        Marker::FixExt16 => {
            let mut buf = [0; 16];
            read_fixext_data(rd, &mut buf).map(|ty| (ty, buf))
...
fn read_fixext_data<R: Read<E>, E: ReadError>(rd: &mut R, buf: &mut [u8]) -> Result<i8, ValueReadError<E>> {
...
pub fn read_ext_meta<R: Read<E>, E: ReadError>(rd: &mut R) -> Result<ExtMeta, ValueReadError<E>> {
