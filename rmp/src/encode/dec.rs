...
/// marker or the data.
pub fn write_f32<W: Write<E>, E: WriteError>(wr: &mut W, val: f32) -> Result<(), ValueWriteError<E>> {
...
/// This function will return `ValueWriteError` on any I/O error occurred while writing either the
/// marker or the data.
pub fn write_f64<W: Write<E>, E: WriteError>(wr: &mut W, val: f64) -> Result<(), ValueWriteError<E>> {
